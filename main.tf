...
module "docdb" {
  source = "github.com/anandnandhu1/tf-module-docdb"
  env    = var.env
...
module "rds" {
  source = "github.com/anandnandhu1/tf-module-rds"
  env    = var.env
...
module "elasticache" {
  source = "github.com/anandnandhu1/tf-module-elasticache"
  env    = var.env
...
module "alb" {
  source = "github.com/anandnandhu1/tf-module-alb"
  env    = var.env
...
##this is for servers mutable and immutable
//module "apps" {
//  source = "github.com/anandnandhu1/tf-module-app"
//  env    = var.env
//
